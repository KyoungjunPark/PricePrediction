...
class DataMatricesCoin:
    def __init__(self, start, end, period, batch_size=50, volume_average_days=30, buffer_bias_ratio=0,
        ...
        self._num_periods = len(self.__global_data.columns)
        ...
        self.__replay_buffer = rb.ReplayBufferCoin(start_index=self._train_ind[0],
                                                   end_index=end_index,
...
class DataMatricesStock:
    def __init__(self, start, end, period, company_list, batch_size=50, volume_average_days=30, buffer_bias_ratio=0,
                 market="yahoo", window_size=50, feature_number=3, test_portion=0.15,
                 portion_reversed=False, online=False, is_permed=False):
        """
        :param start: Unix time
        :param end: Unix time
